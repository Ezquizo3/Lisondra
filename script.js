...
document.addEventListener('click', playMusicOnClick, false);

document.addEventListener('touchstart', playMusicOnClick, false);
...
var Clock = (function() {
    var canvas,
        ...
        press = false, 
        quiver = true, 
        texts = ["TE AMO 💗"," HOY 💗 ","MAÑANA 💗","Y SIEMPRE 💗","SOLO TÚ YO","💗"],
    ...
    return {
        ...
        event: function() {
          ...
          let autoTextChange = setInterval(function() {
              textNum++;
              if (textNum >= texts.length) {
                  clearInterval(autoTextChange); // Detener al llegar al final
                  return;
                }
                text = texts[textNum];
                console.log(textNum)
